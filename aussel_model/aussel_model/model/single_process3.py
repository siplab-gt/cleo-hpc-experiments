...
#    print('positions generated')
    ...
    inputs1,inputs2,inputs3=apply_input(input_type,A0,A1,dur,f1,duty_cycle,runtime,in_file_1,in_file_2,in_file_3,in_fs, noise_adder=noise_adder)
